    ...
    <footer className="site-footer">
      <div className="footer-top">
        <div className="footer-brand">
          <div className="footer-logo footer-reveal">The Tobacco®</div>
        ...
        <div className="footer-info">
          ...
          <p className="footer-info__text footer-reveal">info@thetobacco.com</p>
        </div>
      </div>
      <div className="footer-line footer-line-anim"></div>
      <div className="footer-bottom">
        <p className="footer-copy footer-reveal">© 2026 The Tobacco Company. Todos los derechos reservados.</p>
