    ...
    <footer className="site-footer">
      <div className="footer-top">
        <div className="footer-brand">
          <div className="footer-logo footer-reveal">D'Tabaco®</div>
        ...
        <div className="footer-info">
          ...
          <p className="footer-info__text footer-reveal">info@dtabaco.com</p>
        </div>
      </div>
      <div className="footer-line footer-line-anim"></div>
      <div className="footer-bottom">
        <p className="footer-copy footer-reveal">© 2026 D'Tabaco Company. Todos los derechos reservados.</p>
